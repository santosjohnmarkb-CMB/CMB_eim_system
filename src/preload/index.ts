...
const ALLOWED_CHANNELS = new Set([
  ...
  'db:equipment:previewCsvCategories',
  'db:equipment:search',
  ...
  'db:packages:update',
  'db:packages:delete',
  'db:packages:bulkImport',
  'packages:readCsvFile',
  'packages:downloadTemplate',
  'db:maintenance:getAll',
  'db:maintenance:getById',
  'db:maintenance:create',
  'db:maintenance:update',
  'db:maintenance:updateStatus',
  'db:maintenance:uploadServiceDoc',
  'db:maintenance:clearServiceDoc',
  ...
  'db:loans:uploadSignedForm',
  'db:loans:clearSignedForm',
  'db:loans:delete',
  ...
  'db:purchaseRequests:uploadInvoice',
  'db:purchaseRequests:clearInvoice',
  ...
  'sync:serviceAccount:status',
  'sync:serviceAccount:set',
  'sync:serviceAccount:clear',
  'gdrive:config:get',
  'gdrive:config:set',
  'gdrive:connect',
  'gdrive:disconnect',
